...
public class RouteOverlay extends Overlay {
    ...
    private final RouteOverlayCallback callback;
    ...
    public RouteOverlay(RouteOverlayCallback callback, final Route route, final int defaultColour) {
	super();
